...
public class WireNodePreviewController : MonoBehaviour
{
    ...
    public void GetAndLinkNodes() {
        ...
        firstWireNodeScript.SetItem(this.wire);
        secondtWireNodeScript.SetItem(this.wire);
    }
    ...
    public void SetWire(WireItem wireItem) {
        this.wire = wireItem;
    }
